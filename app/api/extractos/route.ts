...
function obtenerFechaArgentinaRobusta() {
    try {
        // Método más directo: obtener la fecha actual en Argentina usando toLocaleString
        const ahora = new Date()

        // Obtener la fecha y hora en Argentina
        const fechaArgentinaString = ahora.toLocaleString("en-CA", {
        ...
        const fechaArgentina = new Date(fechaArgentinaString)

        console.log("🕐 FECHA ARGENTINA ROBUSTA:")
        console.log("- Fecha servidor UTC:", ahora.toISOString())
        console.log("- String Argentina:", fechaArgentinaString)
        console.log("- Fecha Argentina creada:", fechaArgentina.toISOString())
        console.log("- Fecha Argentina local:", fechaArgentina.toLocaleString("es-AR"))
        console.log("- Día de la semana:", fechaArgentina.getDay())
        console.log(
            "- Hora Argentina:",
            fechaArgentina.getHours() + ":" + fechaArgentina.getMinutes().toString().padStart(2, "0"),
        )
        ...
        // Fallback más seguro: calcular manualmente UTC-3
        const ahora = new Date()
        const fechaArgentina = new Date(ahora.getTime() - 3 * 60 * 60 * 1000)

        console.log("🕐 FALLBACK FECHA ARGENTINA:")
        console.log("- Fecha servidor UTC:", ahora.toISOString())
        console.log("- Fecha Argentina (UTC-3):", fechaArgentina.toISOString())

        return fechaArgentina
    }
}

function obtenerFechaArgentinaSimple() {
    // Método ultra simple: UTC-3 siempre
    const ahora = new Date()
    const fechaArgentina = new Date(ahora.getTime() - 3 * 60 * 60 * 1000)

    console.log("🕐 FECHA ARGENTINA SIMPLE:")
    console.log("- UTC ahora:", ahora.toISOString())
    console.log("- Argentina (UTC-3):", fechaArgentina.toISOString())
    console.log("- Fecha local Argentina:", fechaArgentina.toLocaleString("es-AR"))
    console.log("- Día:", fechaArgentina.getDate())
    console.log("- Mes:", fechaArgentina.getMonth() + 1)
    console.log("- Año:", fechaArgentina.getFullYear())
...
async function obtenerResultadosConfiables(): Promise<any[]> {
    const fechaActual = obtenerFechaArgentinaSimple()
...
export async function GET(request: Request) {
    try {
        ...
        const fechaActualArgentina = obtenerFechaArgentinaSimple()
